...
bias_correction=[0] # For every phase: set bias correction (in metres)
avalanche_threshold=[700] # For every phase: set highest elevation below which no avalanches are visible (in metres)
upper_detection_threshold=[4] # For every phase: set upper threshold of snow depth anomalies to be removed (in metres)
lower_detection_threshold=[-2] # For every phase: set lower threshold of snow depth anomalies to be removed (in metres)
kernel_size=[200] # For every phase: set kernel size for filter used to detect anomalies (in pixels)
expansion_distance=[10] # For every phase: set distance used to expand anomylous areas to be removed (in pixels)
